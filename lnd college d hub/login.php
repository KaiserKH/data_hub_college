...
$encrypted_params = getEncryptedUrlParams();
$redirect_input = $encrypted_params['redirect'] ?? ($_GET['redirect'] ?? '/index.php');
$safe_redirect = getSafeRedirectPath($redirect_input, '/index.php');
